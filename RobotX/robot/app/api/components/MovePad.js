            ...
            <div>
                ...
                <div className="row" style={{ marginTop: '10px' }}>
                    <div className="col-md-4">
                        ...
                        <button id="moverotateleft" onClick={this.move.bind(this, 'rotateleft')} className="btn btn-default btn-block"><i className="fa fa-rotate-left"></i></button>
                    </div>
                    <div className="col-md-4">
                    ...
                    <div className="col-md-4">
                    <button id="moverotateright" onClick={this.move.bind(this, 'rotateright')} className="btn btn-default btn-block"><i className="fa fa-rotate-right"></i></button>
                    </div>
                </div>
                <div className="row" style={{ marginTop: '10px' }}>
                    <div className="col-md-4">
