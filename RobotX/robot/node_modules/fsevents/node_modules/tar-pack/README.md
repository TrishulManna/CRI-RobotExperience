...
Basic Options:
 ...
 - `defaultName` (defaults to `index.jsx`) If the package is a single file, rather than a tarball, it will be "extracted" to this file name, set to `false` to disable.
